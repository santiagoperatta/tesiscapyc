    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                @auth
					@cannot('create', App\Models\Vacante::class)
						<div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
							...
							<x-nav-link :href="route('datos_personales.index')" :active="request()->routeIs('datos_personales.index')">
								{{ __('Mi CV') }}
							</x-nav-link>
						</div>
					@endcannot
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
				@auth
					@can('create', App\Models\Vacante::class)
						<a class="mr-2 w-7 h-7 bg-blue-600 hover:bg-blue-800 rounded-full flex flex-col justify-center
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @auth
			...
			<div class="pt-2 pb-3 space-y-1">
				...
				<x-responsive-nav-link :href="route('datos_personales.index')" :active="request()->routeIs('datos_personales.index')">
					{{ __('Mi CV') }}
				</x-responsive-nav-link>
			</div>
			@endcannot
